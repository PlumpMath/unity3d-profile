...
1. Download and import [soomla-unity3d-core.unitypackage](http://library.soom.la/fetch/unity3d-core/1.0.4?cf=github) and [unity3d-profile.unitypackage](http://library.soom.la/fetch/unity3d-profile/2.0.3?cf=github). If you also want to use Store related rewards you'll need to go over the instructions of [unity3d-store](https://github.com/soomla/unity3d-store)
